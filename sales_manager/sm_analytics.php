...
<div class="wrapper">
    ...
    <div class="main-content">
        ...
        <div class="filter-section mb-4">
            ...
            <div class="col-md-6">
                <div class="analytics-card mb-4 h-100">
                ...
                <div class="analytics-card mb-4 h-100">
                    ...
                    <div class="card-body chart-container d-flex align-items-center justify-content-center" style="min-height: 450px;">
                        <div style="position: relative; width: 100%; max-width: 450px; height: 400px;">
