...
<body>
    <div class="landing-container">
            ...
            <div class="col-md-6">
                <div class="card h-100">
                    ...
                    <div class="card-body text-center">
                        <h5 class="card-title">Welcome to RotiSeri Bakery</h5>
                        <p class="card-text">Order delicious baked goods online and have them delivered to your doorstep. Existing staff members can also login here.
                            <a href="auth/login.php" class="btn btn-primary btn-lg">Login</a>
                            <a href="auth/register_customer.php" class="btn btn-outline-primary">New Customer? Register Here</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- 
        COMMENTED OUT FOR FUTURE USE - STAFF REGISTRATION CARDS
